...
public class MockDirectory extends Directory {
  ...
  public MockDirectory(List<String> files, HashMap<String, String> fileContents, Map<String, String> fileTypes) throws NonexistentDirectoryException {
    super(DEFAULT_DIRECTORY_PATH);
    this.files = files;
  ...
  public MockDirectory(List<String> subdirectories, List<String> files, HashMap<String, String> fileContents, Map<String, String> fileTypes) throws NonexistentDirectoryException {
    super(DEFAULT_DIRECTORY_PATH);
